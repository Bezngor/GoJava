...
// равных указанному значению. Обратите внимание на то, что метод countMatching() является
...
public class GenericMethodRefDemo {
    ...
    public static void main(String[] args) {
        Integer[] vals = {1, 2, 3, 4, 3, 4, 4, 5};
        String[] strs = {"Один", "Два", "Три", "Два"};
        int conut;

        conut = myOp(MyArrayOps::<Integer> countMatching, vals, 4);
        System.out.println("Массив vals содержит " + conut + " числа 4");

        conut = myOp(MyArrayOps::<String> countMatching, strs, "Два");
        System.out.println("Массив strs содержит " + conut + " числа Два");
    }
}
